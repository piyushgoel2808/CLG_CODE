public class constructor {
    public static void main(String arge[]) {
        ...
        // Teacher t1 = new Teacher(); ////IF A CONSTUCOR IS MADE IT java doesnot make a
        // defalt constructer (with no argumet)
...
class Teacher {
    ...
    Teacher(int A_no) {
        this.A_no = A_no;
        System.out.println("the CONSTRUCTOR is called(PARAMETRIZED CONSTRUCTOR):- " + A_no); // NON PARAMETRIZED
                                                                                             // CONSTRUCTOR
    }
}