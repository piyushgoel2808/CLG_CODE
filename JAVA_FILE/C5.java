...
class StringDemo {
 ...
 public void chara(){
        ...
        System.out.println("The character at index 0 in the first string is: " + str1.charAt(0));
        ...
        System.out.println("The first string is equal to the second string: " + str1.equals(str2));
